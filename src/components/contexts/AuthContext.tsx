...
export interface AuthContextType {
  ...
  enabledEncounters: Record<string, boolean>;
  setPassword: (newPassword: string) => Promise<void>;
  verifyPassword: (inputPassword: string) => Promise<boolean>;
  updateEncounters: (newEncounters: Record<string, boolean>) => void;
  login: (username: string, password: string, department: string) => void;
  logout: () => void;
}
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const updateEncounters = (newEncounters: Record<string, boolean>) => {
  ...
  const login = (username: string, password: string, department: string) => {
