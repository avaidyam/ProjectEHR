...
import { useSnowmedInfiniteSearch } from '../../../services/snowmed';
            ...
            return (
                <Box sx={{ p: 2 }}>
                    <Alert severity="info" sx={{ mx: 2 }}>
                        ...
                        Database search is temporarily unavailable due to SNOMED API connectivity issues.
                    </Alert>
                </Box>
            );
        }
                            ...
                            >
                                <TableCell>
                                    ...
                                    <Typography variant="caption" color="text.secondary">
                                        {result.fullName} • ID: {result.conceptId}
                                    </Typography>
                                </TableCell>
