...
import { usePreferenceLists } from './PreferenceListContext';
...
const PreferenceListTab = ({ searchTerm = '' }) => {
    ...
    const getSearchResults = () => {
        ...
        preferenceLists.forEach(list => {
            const matchingDiagnoses = list.diagnoses.filter(diagnosis =>
                ...
                diagnosis.term.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    return (
        <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            {/* TODO: Add ability to add new diagnoses to preference lists */}
            {/* TODO: Add ability to create/delete personal preference lists */}
            {/* TODO: Add drag-and-drop reordering within lists */}
            {/* TODO: Add favorites/pinning functionality for left sidebar */}
            {/* TODO: Connect to backend API for persistence */}
            {/* TODO: Sync changes with left sidebar tree structure */}
            {/* TODO: Add bulk operations (select multiple, move between lists) */}
        </Box>
    );
};
