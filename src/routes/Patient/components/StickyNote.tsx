...
interface WindowState {
  ...
  pos: { left: number | null; top: number | null };
...
const useStickyWindow = (type: string, initialContent: string | undefined, defaultW: number, defaultH: number, offsetX: number, offsetY: number): WindowState => {
  ...
  const syncContent = (newContent: string) => {
...
const StickyNoteWindow: React.FC<StickyNoteWindowProps> = ({ windowState, title, color, bgColor, onClose, children }) => {
